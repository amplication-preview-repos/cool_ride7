...
@InputType()
class TypingErrorCreateNestedManyWithoutTypingResultsInput {
...
export { TypingErrorCreateNestedManyWithoutTypingResultsInput as TypingErrorCreateNestedManyWithoutTypingResultsInput };
