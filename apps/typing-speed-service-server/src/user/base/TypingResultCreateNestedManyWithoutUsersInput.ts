...
@InputType()
class TypingResultCreateNestedManyWithoutUsersInput {
...
export { TypingResultCreateNestedManyWithoutUsersInput as TypingResultCreateNestedManyWithoutUsersInput };
