...
@InputType()
class TypingResultCreateNestedManyWithoutTypingTestsInput {
...
export { TypingResultCreateNestedManyWithoutTypingTestsInput as TypingResultCreateNestedManyWithoutTypingTestsInput };
